              ...
              <div class="pb-16 grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-5">
                ...
                <div class="col-span-2 sm:col-span-3 md:col-span-2">
                  ...
                  <ul class="list-inside mt-4 space-y-4">
                    ...
                    <li>
                      <a href="mailto:meschacirung@gmail.com" class="hover:text-cyan-400 transition">contact@tailus.com</a>
                    </li>
                    <li>
                      <form action="">
                        <label for="newsletter" class="text-lg text-white">Subscribe to our newsletter</label>
                        <div class="relative mt-4">
                          <input type="email" name="newsletter" id="newsletter" placeholder="Your email" class="w-full px-4 py-3 ring-1 ring-cyan-700 rounded-xl bg-gray-900 bg-opacity-20 invalid:ring-red-400 invalid:outline-none"></input>
                          <button type="submit" title="Submit" class="absolute right-0 w-max py-3 px-6 text-center rounded-r-xl transition bg-cyan-400 hover:bg-cyan-300 active:bg-cyan-600 focus:bg-cyan-300">
