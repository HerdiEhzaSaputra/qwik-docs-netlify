                ...
                <div class="container m-auto px-6 md:px-12 lg:px-6">
                    <div class="lg:flex lg:items-center lg:gap-x-16">
                            ...
                            <div class="grid grid-cols-3 space-x-4 md:space-x-6 md:flex">
                                <a aria-label="add to slack" href="#" class="p-4 border border-gray-200 rounded-md hover:border-cyan-400 hover:shadow-lg">
                                    <div class="flex justify-center space-x-4">
                                        <img class="w-6" src="https://tailus.io/sources/blocks/tech-startup/preview/images/slack.png" alt="slack logo" loading="lazy" width="128" height="128"></img>
                                ...
                                <a aria-label="add to chat" href="#" class="p-4 border border-gray-200 rounded-md hover:border-green-400 hover:shadow-lg">
                                    <div class="flex justify-center space-x-4">
                                        <img class="w-6" src="https://tailus.io/sources/blocks/tech-startup/preview/images/chat.png" alt="chat logo" loading="lazy" width="128" height="128"></img>
                                ...
                                <a aria-label="add to zoom" href="#" class="p-4 border border-gray-200 rounded-md hover:border-blue-400 hover:shadow-lg">
                                    <div class="flex justify-center space-x-4">
                                        <img class="w-6" src="https://tailus.io/sources/blocks/tech-startup/preview/images/zoom.png" alt="chat logo" loading="lazy" width="128" height="128"></img>
                        ...
                        <div hidden class="lg:block lg:w-5/12">
                            <img src="https://tailus.io/sources/blocks/tech-startup/preview/images/watch.svg" class="w-full" alt="wath illustration" loading="lazy" width="320" height="280"></img>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="py-8 px-12 bg-cyan-50 rounded-2xl">
                        ...
                        <div class="mt-8 flex justify-center flex-wrap items-center gap-4 md:gap-6 lg:gap-8">
                            <div class="flex items-center">
                                <img class="w-36" src="https://tailus.io/sources/blocks/tech-startup/preview/images/clients/microsoft.png" alt="client logo" loading="lazy" width="584" height="122"></img>
                            </div>
                            <div class="flex items-center">
                                <img class="w-28" src="https://tailus.io/sources/blocks/tech-startup/preview/images/clients/myob.png" alt="client logo" loading="lazy" width="400" height="219"></img>
                            </div>
                            <div class="flex items-center">
                                <img class="w-28" src="https://tailus.io/sources/blocks/tech-startup/preview/images/clients/grabyo.png" alt="client logo" loading="lazy" width="400" height="219"></img>
                            </div>
                            <div class="flex items-center">
                                <img class="w-32" src="https://tailus.io/sources/blocks/tech-startup/preview/images/clients/lifegroups.png" alt="client logo" loading="lazy" width="400" height="219"></img>
                            </div>
                            <div class="flex items-center">
                                <img class="w-24" src="https://tailus.io/sources/blocks/tech-startup/preview/images/clients/lilly.png" alt="client logo" loading="lazy" width="400" height="219"></img>
                            </div>
                            <div class="flex items-center">
                                <img class="w-28" src="https://tailus.io/sources/blocks/tech-startup/preview/images/clients/grabyo.png" alt="client logo" loading="lazy" width="400" height="219"></img>
                            </div>
